...
<a href="<?= $nextPageUrl ?>" id="lwNextPageLink" class="col-sm-12 alert alert-dark text-center bg-dark text-secondary border-0 mt-5 lw-ajax-link-action" data-method="get" data-callback="loadNextLikedUsers"><?= __tr('Load more') ?></a>
@else
