												...
												@if($reportData['status'] == 1)
													<div class="btn-group">
														...
														<div class="dropdown-menu dropdown-menu-right">
					 										<a class="dropdown-item" data-toggle="modal" data-target="#reportModerationDialog" data-user-id='<?= $reportData['for_users__id'] ?>' data-user-name="<?= $reportData['reported_user'] ?>" data-report-data='<?= json_encode($reportData['reportedByUser']) ?>'><i class="far fa-edit"></i>  <?= __tr('Moderate') ?></a>
														</div>
													</div>
												@else
													<span>--</span>
